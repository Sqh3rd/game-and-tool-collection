CREATE TYPE "junction_processable_recipe_type" AS ENUM('IN', 'OUT');--> statement-breakpoint
...
CREATE TABLE "fagrc_junction_processable_recipe" (
	...
	"type" "junction_processable_recipe_type",
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "fagrc_processor" ADD CONSTRAINT "fagrc_processor_processable_id_fagrc_processable_id_fkey" FOREIGN KEY ("processable_id") REFERENCES "fagrc_processable"("id");